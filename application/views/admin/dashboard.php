...
<body>
    ...
    <script src="<?php base_url()?>assets/js/plugins/morris/raphael.min.js"></script>
    <script src="<?php base_url()?>assets/js/plugins/morris/morris.min.js"></script>
    <script src="<?php base_url()?>assets/js/plugins/morris/morris-data.js"></script>
